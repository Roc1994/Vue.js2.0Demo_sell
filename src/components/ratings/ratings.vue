<template>
  <div class="ratings" ref="ratings">
    <div class="ratings-content">
      ...
      <split></split>
      <ratingselect v-on:ratingtype-select="ratingType" v-on:content-toggle="contentToggle" :select-Type="selectType" :only-Content="onlyContent" :ratings="ratings"></ratingselect>
